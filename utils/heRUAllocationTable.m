...
%   P802.11ax/D4.1, Table 27-24. Each row of the table is a resource unit
...
if isempty(allocationTable) || isempty(allocations)
    ...
    for i = 1:offset
        allocations(i).BitAllocation = regexprep(string(num2str ...
            (reshape(int2bit(allocations(i).Allocation,8),8,[])')),' ','');
    end
